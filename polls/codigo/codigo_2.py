...
def pergunta(palavra, conjuntoDeLetras, resposta, palavraTermo, vidas):
...
pergunta(informacoes.palavra, informacoes.conjuntoDeLetras, informacoes.resposta, informacoes.palavraTermo, informacoes.vidas)
